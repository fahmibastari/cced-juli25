...
const ChangePasswordForm = ({ userId }: { userId: string }) => {
  ...
  const methods = useForm({
    ...
    defaultValues: {
      oldPassword: '', // Menetapkan default value kosong
      newPassword: '', // Menetapkan default value kosong
      confirmPassword: '' // Menetapkan default value kosong
    }
  })
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          value={field.value ?? ''}  // Menyediakan fallback
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
